...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, class: :input, hint_class: :hint, error_class: :error, valid_class: :valid do |b|
    b.use :html5
    b.use :placeholder
  ...
  config.wrappers :horizontal_form, tag: 'div', class: 'row', hint_class: :hint, error_class: :error, valid_class: :valid do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :inline_form, tag: 'div', class: 'column small-4', hint_class: :hint, error_class: :error, valid_class: :valid do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
